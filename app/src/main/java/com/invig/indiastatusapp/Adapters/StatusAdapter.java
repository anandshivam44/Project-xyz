package com.invig.indiastatusapp.Adapters;
...
import com.invig.indiastatusapp.api.apiClient;
import com.invig.indiastatusapp.api.apiRest;
import com.invig.indiastatusapp.model.ApiResponse;
import com.invig.indiastatusapp.model.Category;
import com.invig.indiastatusapp.model.Slide;
import com.invig.indiastatusapp.model.Status;
import com.invig.indiastatusapp.model.User;
import com.invig.indiastatusapp.Provider.DownloadStorage;
import com.invig.indiastatusapp.Provider.FavoritesStorage;
import com.invig.indiastatusapp.Provider.PrefManager;
import com.invig.indiastatusapp.ui.Activities.AllFullScreenCategoryActivity;
import com.invig.indiastatusapp.ui.Activities.AllFullScreenFollowActivity;
import com.invig.indiastatusapp.ui.Activities.AllFullScreenSearchActivity;
import com.invig.indiastatusapp.ui.Activities.AllFullScreenUserActivity;
import com.invig.indiastatusapp.ui.Activities.AllPortaitVideosActivity;
import com.invig.indiastatusapp.ui.Activities.GifActivity;
import com.invig.indiastatusapp.ui.Activities.ImageActivity;
import com.invig.indiastatusapp.ui.Activities.PlayerActivity;
import com.invig.indiastatusapp.ui.Activities.QuoteActivity;
import com.invig.indiastatusapp.ui.Activities.UserActivity;
import com.invig.indiastatusapp.ui.Activities.VideoActivity;
import com.squareup.picasso.Picasso;
import com.invig.indiastatusapp.ui.Activities.YoutubeActivity;
import com.invig.indiastatusapp.ui.view.ClickableViewPager;
...
/**
 * Created by umashankar on 10/07/2020. bought on codecanyon for about 10 days ago08/10/2017.
 */
...
//            Log.v("this is path",statusList.get(position).getPath());
    ...
    class DownloadFileFromURL extends AsyncTask<Object, String, String> {
        ...
        public void AddDownloadLocal(Integer position){
            final DownloadStorage downloadStorage= new DownloadStorage(activity.getApplicationContext());
            List<com.invig.indiastatusapp.model.Status> download_list = downloadStorage.loadImagesFavorites();
            Boolean exist = false;
            ...
            if (exist  == false) {
                ArrayList<com.invig.indiastatusapp.model.Status> audios= new ArrayList<com.invig.indiastatusapp.model.Status>();
                for (int i = 0; i < download_list.size(); i++) {
                    audios.add(download_list.get(i));
                }
                com.invig.indiastatusapp.model.Status videodownloaded = statusList.get(position);
