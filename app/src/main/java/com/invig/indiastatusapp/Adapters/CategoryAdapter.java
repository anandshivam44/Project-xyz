...
import com.invig.indiastatusapp.ui.Activities.AllCategoryActivity;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        switch (getItemViewType(position)) {
            ...
            case 1: {
                ...
                Picasso.get().load(categoryList.get(position).getImage()).placeholder(R.drawable.placeholder).into(categoryHolder.image_view_item_category_status);
                int index = 0;
