...
public class Transactiondapter extends RecyclerView.Adapter<Transactiondapter.TransactionHolder> {
    ...
    public void onBindViewHolder(TransactionHolder holder,final int position) {
        ...
        Picasso.get().load(transactionList.get(position).getImage()).placeholder(context.getResources().getDrawable(R.drawable.placeholder)).error(context.getResources().getDrawable(R.drawable.image_quote)).into(holder.image_view_item_earning);
    }
    @Override
