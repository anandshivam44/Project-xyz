package com.project.x.Adapters;
...
import com.project.x.api.apiClient;
import com.project.x.api.apiRest;
import com.project.x.model.ApiResponse;
import com.project.x.model.Category;
import com.project.x.model.Slide;
import com.project.x.model.Status;
import com.project.x.model.User;
import com.project.x.Provider.DownloadStorage;
import com.project.x.Provider.FavoritesStorage;
import com.project.x.Provider.PrefManager;
import com.project.x.ui.Activities.AllFullScreenCategoryActivity;
import com.project.x.ui.Activities.AllFullScreenFollowActivity;
import com.project.x.ui.Activities.AllFullScreenSearchActivity;
import com.project.x.ui.Activities.AllFullScreenUserActivity;
import com.project.x.ui.Activities.AllPortaitVideosActivity;
import com.project.x.ui.Activities.GifActivity;
import com.project.x.ui.Activities.ImageActivity;
import com.project.x.ui.Activities.PlayerActivity;
import com.project.x.ui.Activities.QuoteActivity;
import com.project.x.ui.Activities.UserActivity;
import com.project.x.ui.Activities.VideoActivity;
import com.project.x.ui.Activities.YoutubeActivity;
import com.squareup.picasso.Picasso;
import com.project.x.ui.view.ClickableViewPager;
...
//            Log.v("this is path",statusList.get(position).getPath());
    ...
    class DownloadFileFromURL extends AsyncTask<Object, String, String> {
        ...
        public void AddDownloadLocal(Integer position){
            final DownloadStorage downloadStorage= new DownloadStorage(activity.getApplicationContext());
            List<com.project.x.model.Status> download_list = downloadStorage.loadImagesFavorites();
            Boolean exist = false;
            ...
            if (exist  == false) {
                ArrayList<com.project.x.model.Status> audios= new ArrayList<com.project.x.model.Status>();
                for (int i = 0; i < download_list.size(); i++) {
                    audios.add(download_list.get(i));
                }
                com.project.x.model.Status videodownloaded = statusList.get(position);
